...
parser.add_argument('--passing_prob', default=[0.0,0.1,0.1,0.1], type=float, nargs="+", help='a')
parser.add_argument('--recycling_prob', default=[0.0,0.1,0.1,0.1], type=float, nargs="+", help='a')
